...
For additional actions that can be performed related to bundles, please consult the link:https://nifi.apache.org/docs/nifi-registry-docs/rest-api/rest-api.html[REST API documentation].