...
public class ExtensionProvidedServiceApiEntityRowMapper implements RowMapper<ExtensionProvidedServiceApiEntity> {

    @Override
    public ExtensionProvidedServiceApiEntity mapRow(final ResultSet rs, final int i) throws SQLException {
