...
/**
 * Base class for implementations of {@link org.apache.nifi.registry.security.authorization.ConfigurableUserGroupProvider}
 * backed by a relational database. Sub-classes must provide access to a {@link DataSource} and any identity mappings.
 */
public abstract class AbstractDatabaseUserGroupProvider implements ConfigurableUserGroupProvider {

    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractDatabaseUserGroupProvider.class);
    ...
    /**
     * Provides the DataSource required interacting with the database.
     *
     ...
     */
    protected abstract void populateInitialUsers(final AuthorizerConfigurationContext configurationContext);
